// نارموون - Main JavaScript Functions
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const animatedElements = document.querySelectorAll('.feature-card, .pricing-card, .step-item, .stat-item');
        ...
        counters.forEach(counter => {
            ...
            if (target) {
                ...
                const timer = setInterval(() => {
                    ...
                    counter.textContent = Math.floor(current).toLocaleString('fa-IR') + suffix;
                }, 50);
            }
        });
    }
    ...
    function showNotification(message, type = 'info') {
        ...
        notification.style.cssText = `
            ...
            top: 20px;
            right: 20px;
            background: ${type === 'success' ? '#28a745' : type === 'error' ? '#dc3545' : '#20B2AA'};
            color: white;
            padding: 15px 20px;
            border-radius: 8px;
            z-index: 10000;
